...
class FailtureViewController : UIViewController {
    ...
    lazy var topImageView: UIImageView = {
        ...
        resultView.image = UIImage(named: "connect_fail_icon")
        return resultView
    }()
    
    lazy var titleLabel: UILabel = {
        let resultView = UILabel()
        resultView.text = "Connection Failed"
...
extension FailtureViewController {
